...
class GraphRelationshipType(str, Enum):
    CASE_HAS_PERSON = "CASE_HAS_PERSON"
    ...
    CASE_HAS_OFFICER = "CASE_HAS_OFFICER"
    CASE_HAS_UNIT = "CASE_HAS_UNIT"
    CASE_HAS_COURT = "CASE_HAS_COURT"
    CASE_HAS_LOCATION = "CASE_HAS_LOCATION"
    CASE_HAS_ACT = "CASE_HAS_ACT"
    CASE_HAS_SECTION = "CASE_HAS_SECTION"
